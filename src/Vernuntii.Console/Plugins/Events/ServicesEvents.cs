...
namespace Vernuntii.Plugins.Events
{
    ...
    public static class ServicesEvents
    {
        ...
        /// </summary>
        public static readonly EventDiscriminator CreateServiceProvider = new();
        ...
        /// </summary>
        public static readonly EventDiscriminator<IServiceProvider> CreatedServiceProvider = new();
    }
}
