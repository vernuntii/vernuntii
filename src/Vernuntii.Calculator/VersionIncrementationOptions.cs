...
namespace Vernuntii
{
    ...
    /// </summary>
    public sealed class VersionIncrementationOptions
    {
        ...
        /// </summary>
        public bool IsStartVersionCoreAlreadyReleased { get; set; }
        ...
        internal bool IsPostVersionPreRelease => IsPostTransformerUsable
            ? PostTransformer.IsTransformationResultingIntoPreRelease
            : StartVersion.IsPreRelease;
