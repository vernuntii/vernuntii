...
namespace Vernuntii.Extensions
{
    ...
    public static class FileDerivedConfigurationProviderQueueExtensions
    {
        ...
        /// <br/>1. If key <see cref="GitCommandOptions.WorkingTreeDirectory"/> is not set, then it will be shadowed by directory containing the configuration file.
        /// If key <see cref="GitCommandOptions.WorkingTreeDirectory"/> is set but relative, then it will be shadowed by its path relative to the directory containing
