namespace Vernuntii.IO
{
    ...
    {
        internal static readonly FileFinder s_default = new();
        ...
        private static IFileFindingEnumerator FindUpwardDirectoryContainingFile(string directoryPath, string fileName) => new FileFindingEnumerator(
            directoryPath,
            fileName,
            HigherLevelDirectory.FindDirectoryWithFile(fileName, directoryPath, includeBeginningDirectory: true).Enumerator);
