...
namespace Vernuntii.Plugins
{
    ...
    {
        private readonly static VersioningPresetsPlugin DefaultPlugin = new VersioningPresetsPlugin();

        private static IEnumerable<object[]> DefaultPresetNames()
        {
        ...
        private static IEnumerable<object[]> DefaultIncrementFlowNames()
        {
        ...
        private static IEnumerable<object[]> DefaultHeightConventionNames()
        {
        ...
        private static IEnumerable<object[]> DefaultMessageIndicatorNames()
        {
